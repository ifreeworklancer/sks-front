...
(function () {
    ...
    /**
     * Height description project slider item
     */
    window.onload = function () {
        setProjectCardDescriptionHeight();
    };

    function setProjectCardDescriptionHeight() {
        let projectCard = document.querySelectorAll('.project-card .content .description');
        let projectCardDescriptionHeight;
        projectCard.forEach(item => {
            projectCardDescriptionHeight = item.offsetHeight;
            $(item).css('margin-bottom', `-${projectCardDescriptionHeight}px`);
        });
    }
